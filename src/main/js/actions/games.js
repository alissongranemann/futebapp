...
export const startAddGame = (groupId = '', gameData = {}) => (dispatch) => {
    const {
        location = '',
        date = '',
        time = '',
...
export const startRemoveGame = ({ id, groupId } = {}) => dispatch => database.ref(`games/${id}`).remove().then(() => {
...
export const startEditGame = (id, updates) => dispatch => database.ref(`games/${id}`).update(updates).then(() => {
